...
현재 공개 버전: **0.5.4**. 기본 분석은 규칙 기반이며 모델 가중치나 AI 서버가 필요하지 않습니다.

## 실행

[Releases](https://github.com/sukwoo0711-maker/FlowNote/releases/tag/v0.5.4)에서
`FlowNote-0.5.4-win-x64-core-setup.exe` 설치본 또는 `FlowNote-0.5.4-win-x64-core.zip` 포터블을 받습니다.
...
검수와 제한 사항은 `docs/releases/0.5.4.md`를 참고하세요.
